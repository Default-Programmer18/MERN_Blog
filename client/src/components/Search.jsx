...
import NoRelatedPost from "../assets/NoRelatedPost.jpg";
        ...
        <div className="p-7 flex flex-wrap gap-5">
          {!loading && posts.length === 0 && (
            <div className="flex flex-col justify-center items-center   ">
              ...
              <img src={NoRelatedPost} className=" w-[40%] h-[80%]"></img>
              <h1 className="font-semibold text-2xl mt-3">No Related Post Found... </h1>
